function intersectBezier2Bezier2(a1, a2, a3, b1, b2, b3) {
    ...
    c20 = new Phaser.Point(b1.x, b1.y);
                ...
                for ( var j = 0; j < xRoots.length; j++ ) {
                    ...
                    if ( 0 <= xRoot && xRoot <= 1 ) {
                        for ( var k = 0; k < yRoots.length; k++ ) {
                            if ( Math.abs( xRoot - yRoots[k] ) < 1e-4 ) {
								return true;
                            }
                        }
                    }
...
function intersectBezier2Bezier3(a1, a2, a3, b1, b2, b3, b4) {
    ...
    c23 = new Phaser.Point(d.x, d.y);

    a = b1.multiply(3);
    b = b2.multiply(-6);
    c = b3.multiply(3);
    d = a.add(b.add(c));
    c22 = new Phaser.Point(d.x, d.y);

    a = b1.multiply(-3);
    b = b2.multiply(3);
    c = a.add(b);
    c21 = new Phaser.Point(c.x, c.y);
...
function intersectBezier2Circle(p1, p2, p3, c, r) {
    return intersectBezier2Ellipse(p1, p2, p3, c, r, r);
}
...
function intersectBezier2Line(p1, p2, p3, a1, a2) {
    ...
    n = new Phaser.Point(a1.y - a2.y, a2.x - a1.x);
...
function intersectBezier2Polygon(p1, p2, p3, points) {
    var length = points.length;

    for ( var i = 0; i < length; i++ ) {
        var a1 = points[i];
        var a2 = points[(i+1) % length];
        var inter = intersectBezier2Line(p1, p2, p3, a1, a2);
...
function intersectBezier2Rectangle(p1, p2, p3, r1, r2) {
    var min        = r1.min(r2);
    var max        = r1.max(r2);
    var topRight   = new Point2D( max.x, min.y );
    var bottomLeft = new Point2D( min.x, max.y );
    
    var inter1 = intersectBezier2Line(p1, p2, p3, min, topRight);
    var inter2 = intersectBezier2Line(p1, p2, p3, topRight, max);
    var inter3 = intersectBezier2Line(p1, p2, p3, max, bottomLeft);
    var inter4 = intersectBezier2Line(p1, p2, p3, bottomLeft, min);
...
function intersectBezier3Bezier3(a1, a2, a3, a4, b1, b2, b3, b4) {
    ...
    c13 = new Phaser.Point(d.x, d.y);

    a = a1.multiply(3);
    b = a2.multiply(-6);
    c = a3.multiply(3);
    d = a.add(b.add(c));
    c12 = new Phaser.Point(d.x, d.y);

    a = a1.multiply(-3);
    b = a2.multiply(3);
    c = a.add(b);
    c11 = new Phaser.Point(c.x, c.y);
...
function intersectBezier3Circle(p1, p2, p3, p4, c, r) {
    return intersectBezier3Ellipse(p1, p2, p3, p4, c, r, r);
}
...
function intersectBezier3Ellipse(p1, p2, p3, p4, ec, rx, ry) {
    ...
    c3 = new Phaser.Point(d.x, d.y);

    a = p1.multiply(3);
    b = p2.multiply(-6);
    c = p3.multiply(3);
    d = a.add(b.add(c));
    c2 = new Phaser.Point(d.x, d.y);

    a = p1.multiply(-3);
    b = p2.multiply(3);
    c = a.add(b);
    c1 = new Phaser.Point(c.x, c.y);
...
function intersectBezier3Polygon(p1, p2, p3, p4, points) {
    var length = points.length;

    for ( var i = 0; i < length; i++ ) {
        var a1 = points[i];
        var a2 = points[(i+1) % length];
        var inter = intersectBezier3Line(p1, p2, p3, p4, a1, a2);
...
function intersectBezier3Rectangle(p1, p2, p3, p4, r1, r2) {
    var min        = r1.min(r2);
    var max        = r1.max(r2);
    var topRight   = new Phaser.Point( max.x, min.y );
    var bottomLeft = new Phaser.Point( min.x, max.y );
    
    var inter1 = intersectBezier3Line(p1, p2, p3, p4, min, topRight);
    var inter2 = intersectBezier3Line(p1, p2, p3, p4, topRight, max);
    var inter3 = intersectBezier3Line(p1, p2, p3, p4, max, bottomLeft);
    var inter4 = intersectBezier3Line(p1, p2, p3, p4, bottomLeft, min);
...
function intersectCircleEllipse(cc, r, ec, rx, ry) {
...
function intersectCircleRectangle(c, r, r1, r2) {
    var min        = r1.min(r2);
    var max        = r1.max(r2);
    var topRight   = new Phaser.Point( max.x, min.y );
    var bottomLeft = new Phaser.Point( min.x, max.y );
...
function intersectEllipseEllipse(c1, rx1, ry1, c2, rx2, ry2) {
    var a = [
...
function intersectEllipseLine(c, rx, ry, a1, a2) {
    var origin = new Phaser.Point(a1.x, a1.y);
    var dir    = Phaser.Point.fromPoints(a1, a2);
    var center = new Phaser.Point(c.x, c.y);
    var diff   = origin.subtract(center);
    var mDir   = new Phaser.Point( dir.x/(rx*rx),  dir.y/(ry*ry)  );
    var mDiff  = new Phaser.Point( diff.x/(rx*rx), diff.y/(ry*ry) );
...
function intersectEllipsePolygon(c, rx, ry, points) {
    var length = points.length;
...
function intersectEllipseRectangle(c, rx, ry, r1, r2) {
    var min        = r1.min(r2);
    var max        = r1.max(r2);
    var topRight   = new Phaser.Point( max.x, min.y );
    var bottomLeft = new Phaser.Point( min.x, max.y );
...
function intersectPolygonPolygon(points1, points2) {
...
function intersectPolygonRectangle(points, r1, r2) {
    var min        = r1.min(r2);
    var max        = r1.max(r2);
    var topRight   = new Phaser.Point( max.x, min.y );
    var bottomLeft = new Phaser.Point( min.x, max.y );
    
    var inter1 = intersectLinePolygon(min, topRight, points);
    var inter2 = intersectLinePolygon(topRight, max, points);
    var inter3 = intersectLinePolygon(max, bottomLeft, points);
    var inter4 = intersectLinePolygon(bottomLeft, min, points);
